            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem
                  ...
                  text={
                    data?.rent_start_date
                      ? format(parseISO(data?.rent_start_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                <FormListItem
                  label="Rent End Date"
                  text={
                    data?.rent_end_date ? format(parseISO(data?.rent_end_date as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
