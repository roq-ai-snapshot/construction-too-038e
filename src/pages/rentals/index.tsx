  ...
  const columns: ColumnType[] = [
    {
      ...
      accessorKey: 'rent_start_date',
      cell: ({ row: { original: record } }: any) =>
        record?.rent_start_date ? format(parseISO(record?.rent_start_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'rent_end_date',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.rent_end_date ? format(parseISO(record?.rent_end_date as unknown as string), 'dd-MM-yyyy') : '',
    },
