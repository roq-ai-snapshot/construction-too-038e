...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Fleet Manager.create': { roles: ['owner'], key: 'fleet_add', tenantPath: [], userPath: [] },
  'Fleet Manager.delete': { roles: ['owner'], key: 'fleet_remove', tenantPath: [], userPath: [] },
  'Guest.create': { roles: ['owner', 'fleet-manager', 'admin'], key: 'booking_create', tenantPath: [], userPath: [] },
};
